...
public class Fragment1 extends Fragment {
    ...
    int []com = new int[3];     // 실제 답
    int []user = new int[3];    // 플레이어가 입력한 답
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((playerAnswer.getText().toString()).equals("")) {
                    ...
                    user[0] = yourAnswer / 100;
                    user[1] = (yourAnswer - (user[0] * 100)) / 10;
                    user[2] = (yourAnswer - (user[0] * 100 + user[1] * 10));
                }   // 플레이어 답을 배열에 저장
    ...
    private void resetAnswer() {
        ...
        answer = com[0] * 100 + com[1] * 10 + com[2];
    }   // 정답 초기화
}
